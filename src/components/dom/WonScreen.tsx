...
const WonScreen = () => {
	...
	return (
		<div className="flex h-[100%] w-[100%] flex-col items-center justify-center gap-4 bg-black bg-gradient-radial-won">
			...
			<h1 className="text-8xl tracking-tighter text-[#f5f5f7]">You Won</h1>
			<button
