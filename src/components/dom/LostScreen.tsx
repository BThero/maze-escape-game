...
const LostScreen = () => {
	...
	return (
		<div className="flex h-[100%] w-[100%] flex-col items-center justify-center gap-4 bg-[#2D0C0C] bg-gradient-radial-lost">
			...
			<h1 className="text-8xl tracking-tighter text-[#f5f5f7]">You Lost</h1>
			<button
